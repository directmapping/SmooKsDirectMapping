...
public class UploadServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse resp)
				 ...
				 the_json_array = myjson.getJSONArray("mapping");
						 ...
						 //the_json_array
						    ...
						    JsonObject jsonObj = new JsonObject();
					 		...
					 		jsonObj.add("mapping", null);
					 		jsonObj.add("functions", null);
					 		jsonObj.addProperty("source", myjson.getString("source"));
			     ...
			     Gson gson = new Gson();
			 		...
			 		*/
					    ...
					    try{
						 ...
						 JsonElement element = gson.toJsonTree(obj.getMapping(), new TypeToken<List<Mappings>>() {}.getType());
						 ...
						 JsonElement elemfunctions = gson.toJsonTree(obj.getFunctions(), new TypeToken<List<Functions>>() {}.getType());
						 ...
						 JsonArray functionsArray = elemfunctions.getAsJsonArray();
							...
							String destinationXML = getStoredXML(obj.getDestination(), "destinationXML");
	 ...
	 private void returnJSON( JsonObject jsonObj, PrintWriter out) throws IOException, SAXException {
...
private void returnJSON( String json , PrintWriter out) throws IOException, SAXException {
	 ...
	 private void writeResponse(PrintWriter writer, String failureReason, String json)
	    {
